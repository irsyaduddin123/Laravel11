            ...
            <div class="col-md-7 col-lg-4 mb-5 mb-lg-0 wow fadeIn">
                <div class="card border-0 shadow">
                    @empty($pelanggan->foto)
                        <img src="{{ url('admin/images/nopoto.jpg') }}" alt="project-image" class="rounded">
                    @else
                        <img src="{{ url('admin/images') }}/{{ $pelanggan->foto }}" alt="project-image" class="rounded">
                    @endempty
                    <div class="card-body p-1-9 p-xl-5">
                        <div class="mb-4">
                            <h3 class="h4 mb-0">{{ $pelanggan->nama }}</h3>
                            {{-- <h3 class="h4 mb-0">{{ $pelanggan->kartu->nama }}</h3> --}}
                            <span class="text-primary">{{ $pelanggan->kartu->nama }}</span>
                        </div>
                        <ul class="list-unstyled mb-4">
                            <li class="mb-3"><a href="#!"><i
                                        class="far fa-envelope display-25 me-3 text-secondary"></i>{{ $pelanggan->email }}</a>
                            </li>
                            <li class="mb-3"><a href="#!"><i
                                        class="fas fa-mobile-alt display-25 me-3 text-secondary"></i>{{ $pelanggan->tgl_lahir }}</a>
                            </li>
